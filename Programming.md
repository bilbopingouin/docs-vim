...
See [Ref.](http://vimdoc.sourceforge.net/htmldoc/usr_30.html#30.5)
...
More in the [wikia](http://vim.wikia.com/wiki/Browsing_programs_with_tags) and [Code_review](code_review.md)
