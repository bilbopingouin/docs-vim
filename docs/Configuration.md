...
Depending on which version of vim, you either have 16, 256 or 24-bits colouring. The list of 256 colours can be found [here](https://jonasjacek.github.io/colors/). But as a simplified, we have
